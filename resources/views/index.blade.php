    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="img/logo.png" data-active-url="img/logo-active.png"
                        alt=""></a>
            </div>
                ...
                <div class="col-md-4">
                    <div class="service">
                        ...
                        <p class="description">A elementum ligula lacus ac quam ultrices a scelerisque praesent vel
                            suspendisse scelerisque a aenean hac montes.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service">
                ...
                <div class="col-md-7 no-padding col-md-offset-5 pricings text-center">
                    <div class="pricing">
                        <div class="box-main active" data-img="img/pricing1.jpg">
                            ...
                            <a href="#" data-toggle="modal" data-target="#modal1" class="btn btn-white-fill">Sign Up
                                Now</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-popup">
                ...
                <form action="" class="popup-form">
                    ...
                    <div class="dropdown">
                        <button id="dLabel" class="form-control form-white dropdown" type="button"
